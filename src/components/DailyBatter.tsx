            ...
            >
              ...
              <div className="text-center p-4">
                <div className="flex items-center justify-center mb-2">
                  ...
                  <span className="text-sm font-tamil text-brown-600">{batter.tamil}</span>
                </div>

                <h4 className="text-base font-semibold text-brown-800 mb-1">{batter.product}</h4>
                <p className="text-sm font-tamil text-brown-600">{batter.tamilProduct}</p>
              </div>
            </div>
          ))}
        </div>
