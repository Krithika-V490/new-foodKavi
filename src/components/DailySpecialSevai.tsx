      ...
      <div className="container-max section-padding">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-primary-800">Daily Special Millet Sevai</h2>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {dailySpecials.map((special, index) => (
            <div key={index} className="bg-cream-50 rounded-xl p-6 card-shadow hover:shadow-xl transition-shadow duration-300">
